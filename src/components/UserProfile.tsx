  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      try {
        ...
        alert('Не удалось импортировать сессии. Убедитесь, что формат файла правильный.');
      }
    }
  };
    ...
    <div className="user-profile">
      ...
      {showDropdown && (
        <div className="user-dropdown">
          <div className="user-details">            <div className="detail-item">
          ...
          <div className="dropdown-actions">            <button className="dropdown-button" onClick={onExportSessions}>
              Экспорт сессий
            </button>
            <button className="dropdown-button" onClick={handleImportClick}>
              Импорт сессий
            </button><button className="dropdown-button logout" onClick={handleLogout}>
              Выйти
            </button>
          </div>
        </div>
